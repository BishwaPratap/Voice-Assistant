...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_CONTAINER', 'FONTSIZE', 'OLE_HANDLE',
           'FONTSTRIKETHROUGH', 'FONTNAME', 'OLE_XPOS_HIMETRIC',
           'Default', 'IFontDisp', 'OLE_YSIZE_PIXELS',
           'OLE_XPOS_PIXELS', 'IFont', 'VgaColor', 'Gray',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC',
           'OLE_CANCELBOOL', 'OLE_YPOS_PIXELS', 'StdFont',
           'OLE_ENABLEDEFAULTBOOL', 'Unchecked', 'Checked',
           'Monochrome', 'StdPicture', 'FONTUNDERSCORE',
           'IFontEventsDisp', 'OLE_XSIZE_PIXELS',
           'OLE_XSIZE_HIMETRIC', 'Picture', 'LoadPictureConstants',
           'OLE_YPOS_CONTAINER', 'Font', 'OLE_OPTEXCLUSIVE',
           'FONTBOLD', 'Color', 'IPicture', 'FontEvents', 'OLE_COLOR',
           'OLE_TRISTATE', 'OLE_XPOS_CONTAINER', 'FONTITALIC',
